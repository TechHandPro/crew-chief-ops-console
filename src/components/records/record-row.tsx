...
export function RecordRow({
  ...
  /** App-router path. Typed as string so `/tickets/${id}` interpolations typecheck. */
  href: string;
  leading: ReactNode;
  trailing: ReactNode;
  children: ReactNode;
  ...
  return (
    <li className="min-w-0">
      <Link
        href={href as Route}
        className="group flex min-w-0 flex-col gap-2 px-4 py-3.5 transition hover:bg-bg-subtle/60 sm:flex-row sm:items-start sm:gap-4 sm:px-5"
      >
